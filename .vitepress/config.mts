      ...
      '/api/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'useMusic', link: '/api/use-music' },
            { text: 'useStreamedMusic', link: '/api/use-streamed-music' },
            { text: 'useSpatialSound', link: '/api/use-spatial-sound' },
            { text: 'useAudioAnalyser', link: '/api/use-audio-analyser' },
            { text: 'useAudioScheduler', link: '/api/use-audio-scheduler' },
            { text: 'usePreloadAudio', link: '/api/use-preload-audio' },
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Audio Settings', link: '/api/audio-settings' },
            { text: 'createWebSocketTransport', link: '/api/create-web-socket-transport' },
            { text: 'createWebRTCTransport', link: '/api/create-web-rtc-transport' },
